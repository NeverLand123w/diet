            ...
            <nav className="bg-white shadow-md sticky top-0 z-50">
                <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            <Link to="https://docs.google.com/forms/d/e/1FAIpQLSfnH5stQJWBqm3HT-ROt9dhyFHqnR-yDkAOJ5RW-QvXW5Yqzg/viewform" className="text-gray-700 hover:bg-gray-200 px-3 py-2 rounded-md text-sm font-medium">Suggestion</Link>
                ...
                <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
                        ...
                        <Link
                            to="https://docs.google.com/forms/d/e/1FAIpQLSfnH5stQJWBqm3HT-ROt9dhyFHqnR-yDkAOJ5RW-QvXW5Yqzg/viewform"
                            className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-200"
                            onClick={() => setIsMenuOpen(false)}
                        >
                            Suggestion
