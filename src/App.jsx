                ...
                <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            <Link to="https://docs.google.com/forms/d/e/1FAIpQLSf1if9ITIeob1MafObMIdOdcXdbaTd2yfvNfs4q1EJs8RmuxQ/viewform" className="text-gray-700 hover:bg-gray-200 px-3 py-2 rounded-md text-sm font-medium">Suggestion</Link>
